/*
 * File : debug.c
 * CreateDate : 2019-11-23 08:07:41
 * */
...
struct DBG_Controller_tag st_dbg_default_controller = {
    NULL,
    INT_MAX
};

DBG_Controller dbg_default_controller = &st_dbg_default_controller;
...
void DBG_set_level_func(DBG_Controller controller, int level)
{
...
{
    if (NULL == st_dbg_default_controller.debug_write_fp) {
        st_dbg_default_controller.debug_write_fp = stderr;
    }
}
